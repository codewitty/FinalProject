...
int main()
{
	...
	// try accessors for a single record.
	cout << "Assembly : Name       [" << AssemblyByName01.getName() << "], " << endl;
	cout << "           Type       [" << AssemblyByName01.getType() << "], " << endl;
	cout << "           NumContigs [" << AssemblyByName01.getNumContigs() << "], " << endl;
	cout << "           Size       [" << AssemblyByName01.getSize() << "], " << endl;
	cout << "           N50        [" << AssemblyByName01.getN50() << "], " << endl;
	cout << "           GC         [" << AssemblyByName01.getGc() << "], " << endl;
	cout << "           Unknown    [" << AssemblyByName01.getUnknown() << "], " << endl;
